...
const Footer = () => {
  return (
    <div className="w-full flex justify-center items-center bg-black">
      <div className="relative w-full max-w-[1200px] flex flex-col items-center gap-8 md:gap-10 xl:gap-16 p-5 h-fit min-h-[100px] text-white  md:p-7 xl:p-10 xl:pt-20 bg-linear-to-b  from-zinc-950 to-black">
        ...
        <section className="flex flex-col items-center md:items-start gap-10 md:gap-28 md:flex-row md:justify-start w-full">
          ...
          <div className="flex flex-col gap-2 w-full">
            <section className="w-full flex justify-center">
              <div className="flex-1 flex gap-20 justify-around flex-wrap">
                <LinkList
                  category="Company"
                  itemList={[
